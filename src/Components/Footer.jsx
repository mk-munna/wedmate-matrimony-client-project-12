        ...
        <div className='mt-12 relative'>
            ...
            <div className='my-20 px-10 lg:px-20 flex flex-col lg:flex-row gap-8'>
                ...
                <div className="lg:w-[400px]">
                    ...
                    <p className='mt-4 text-xl text-Description dark:text-Description2'>Your Journey to Love Starts Here with WedMate</p>
                ...
                <div className='flex gap-12 flex-col font-light md:flex-row text-lg'>
                    <div className='w-[340px]'>
                        <h1 className='uppercase text-heading dark:text-heading2 font-normal mb-8'>GET IN TOUCH</h1>
                        <div className='space-y-3 text-Description dark:text-Description2'>
                            <p className='flex items-center gap-3'><SlLocationPin className='text-primary text-4xl' />374 William S Canning Blvd, Fall River MA 2721, USA</p>
                            <p className='flex items-center gap-3'><TbPhoneCall className='text-primary text-2xl' />(+880)1893345368</p>
                            <p className='flex items-center gap-3'><MdOutlineMarkEmailRead className='text-primary text-2xl' />support@webmate.app</p>
                            <p className='flex items-center gap-3'><BsClockHistory className='text-primary text-2xl' />10:00 - 17:00</p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <h1 className='uppercase font-normal text-heading dark:text-heading2 mb-8'>Social media</h1>
            ...
            <hr className='dark:border-gray-600 '/>
            <p className='font-light text-Description dark:text-Description2 text-center py-4'>Copyright © 2024. <a href='#' className='underline cursor-pointer'>WedMate.com</a> All rights reserved.</p>
        </div>
    );
};
